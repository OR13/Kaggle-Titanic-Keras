# From https://www.kaggle.com/llexio/titanic/geneticprogramming/run/838624 (Apache)
...
if __name__ == "__main__":
    ...
    pdtrain.to_csv('./results/genetic/gptrain.csv', index=False)
    ...
    pdtest.to_csv('./results/genetic/gptest.csv', index=False)